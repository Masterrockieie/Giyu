...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn = [[
            InlineKeyboardButton('Click Here', callback_data='start')
        ]]
        reply_markup=InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/Unni0240')
        ], [
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://github.com/Masterrockieie/Giyu'),
